...
use I2ct\CodeSniffer\Helpers\ClassHelper;
use I2ct\CodeSniffer\Helpers\RulesetHelper;
...
class FunctionCommentSniff extends PEAR_Sniffs_Commenting_FunctionCommentSniff
{
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $rulesetHelper->setRuleSeverity('I2ct.Commenting.FunctionComment.MissingParamComment', 0);
        $rulesetHelper->setRuleSeverity('I2ct.Commenting.FunctionComment.MissingReturn', 0);
        $rulesetHelper->setRuleSeverity('I2ct.Commenting.FunctionComment.SpacingAfterParamType', 0);
        $rulesetHelper->setRuleSeverity('I2ct.Commenting.FunctionComment.SpacingAfterParamName', 0);

        // [4] Ignored MissingParamTag rule for PHPUnit test class methods.
        if ($classHelper->isTestClassMethod($stackPtr)) {
            $rulesetHelper->setRuleSeverity('I2ct.Commenting.FunctionComment.MissingParamTag', 0);
